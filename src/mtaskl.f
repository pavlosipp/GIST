C-----------------------------------------------------------------------
C  17.11.89        LAST MODIFICATION 06.02.95     UHS: mtaskl DATA   D
C-----------------------------------------------------------------------
C
     ...
     &                  vbsq,tsc,lsx,lmnb,vlt,vlp,psivt,psivp,pgppv,
...
C
     ...
     &            lmnb,vlt,vlp,psivt,psivp,pgppv,pgttv,pgtpv,al,gla,dna,
     &            dnb)
      end
